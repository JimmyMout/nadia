...
router.route('/aksiologish').post(logInController.checkAuthenticated,hotelIstorikoControler.renderAksiologish);
router.route('/olokl_aksiolog').post(hotelIstorikoControler.Aksiologish);
router.route('/aksiologiseis').get(hotelIstorikoControler.kratiseisRender);
